...
int main() {
    ...
    kvlist_append(input, kvpair_new("test_input.txt", "hello world hello mapreduce test mapreduce hello"));
    kvlist_append(input, kvpair_new("test_input.txt", "goodbye hello test mapreduce world goodbye world"));
